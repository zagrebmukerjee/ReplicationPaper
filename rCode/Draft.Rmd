---
title: '\bf Brother, can you spare a manufacturing job? White Voters\' reaction to Deindustrialization'
...
national_ts <- read_xlsx("../data/National_Data_TS.xlsx")
...
# load voting data
library(data.table)
voting <- fread("..\\data\\voting data.csv")
...
model_input <- model_input %>%
  mutate(
    ...
    # by multipling our regression coefficient against the difference
