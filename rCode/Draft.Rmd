---
title: "Brother, can you spare a manufacturing job? White Voters' reaction to Deindustrialization"
...
### Extension Relative to Baccini and Weymoth (2021)

In their main model, Baccini and Weymouth looked at the effect on gross manufacturing job losses from 2012 to 2015 on the change in Democratic vote share in the 2016 presidential election.

Our key extension of Baccini and Weymouth's analysis is changing the quantity of interest from **gross** manufacturing job losses to **net** manufacturing job losses. For example, in Baccini and Weymouth's model, if a county lost 400 manufacturing jobs from 2012-2015 and also gained 400 manufacturing jobs over the same period, they would count 400 overall layoffs. Using our measure of *net* manufacturing job lossess, we would consider this example a 0 net change in manufacturing employment. Given that job descruction and creation is a natural dynamic within the economy (i.e., creative destruction), we think that *net* job lossess is a more meaningful measure.

Using *net* manufacturing job losses as our outcome, we replicate Baccini and Weymouth's main model, which uses 2012-2015 manufacturing (gross) job losses to explain the change in democratic vote share in 2016. Using their specifications, we find totally opposite results - that a *net* increase in white manufacturing jobs *increased* democratic vote share, while a *net* increase in non-white manufacturing jobs *decreased* democratic vote share. (See Tavble X)

However, we do not trust the result of this specification, because, from 2012 to 2015, the national economy experienced a net increase in manufacturing jobs following the 2008 recession (see Figure 1). During this time of recovery, counties that experienced the most pronounced manufacturing job losses in prior years were also likely to experience the most pronounced recovery. Therefore, because manufacturing job losses pre-2012 are likely negatively correlated with manufacturing job gains from 2012-2015, it is misleading to segment the analysis data to just include job losses from 2012 to 2015. [To DO: Empirically show negative correlation describe here]

If we expand our measure of net manufacturing job losses to include the 2004 to 2011 period - which covers most of the period when the U.S. manufacturing economy was hit most intensley (see figure 1) -- we get a result that is consisent with Baccini and Weymouth's overall conclusion. That is, we find that net white manufacturing job losses decreased democratic vote share, while net non-white manufacturing job lossess increased democratic vote share.

While our main takeway is consistent with Baccini and Weymouth's story, it is important to highlight the substantive importance of the *timing* of manufacturing layoffs on political outcomes. Whereas Baccini and Weymouth's analyis suggests that economic changes lead to immediate political consequences, our analysis shows that economic changes can have lagged and variable effects on political outcomes. 
...
We find that, in aggregate, manufacturing job losses were a driver of change in Democratic vote share in the 2016 election. Breaking it down by race, we see that 

Moreover, we find that, given the evolution of the business cycle, considering only recent job losses can paint a misleading picture of the relationship between manufacturing job losses and changes in vote share. In fact, we find that net manufacturing job losses from 2004 to 2011 are crucial to explaning Trump's 2016 win. This finding suggests that economic changes, like manufacturing layoffs, can have lagged and variable political consequence.
