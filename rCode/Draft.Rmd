...
We find that, in aggregate, manufacturing job losses were associated with loss of Democratic vote share in the 2016 election. 10 manufacturing job losses per worker in a county since 2004 corresponded to a 3.8 \% loss in vote share, plus or minus 3.3 \%. Breaking it down by race, we see that white 
...
### Nationwide Manufacturing Layoffs Per Worker, 1995-2019
...
ggplot(data = national_ts %>% filter(Year >= 1995), aes(x = Year, y = `Job Change per Worker`)) +
