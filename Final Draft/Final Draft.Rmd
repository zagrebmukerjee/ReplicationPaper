...
In this choice we diverge from \cite{Baccini21}, which uses **gross** manufacturing job losses. For example, if a county lost $450$ manufacturing jobs from 2012-2015 and also gained $400$ manufacturing jobs over the same period, this would be $450$ **gross** job losses, but only $50$ **net** job losses. The **gross** measure captures several dynamics unrelated to deindustrialization - for example, seasonal unemployment in a food-manufacturing region, or workers moving between jobs. Thus we believe the **net** job losses over a period are the more accurate measure. 
