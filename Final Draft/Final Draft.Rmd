...
ggplot() +
  ...
  labs(title = "Net Change in Manufacturing Employment from 2004 to 2015",
       subtitle = "",
       fill = "") +
...
Following \cite{Baccini21}, our unit of analysis is the county. This allows us to capture not only the direct effects of deindustrialization on laid-off manufacturing workers, but also on the local economy. The primary outcome variable is the county's change in Democratic vote share between 2012 and 2016. We obtain this from 
...
<!--  what should I read in the counterfactual -->
...
>>>>>>> 536a3a7d6e5e0469a04ffc50d4aa9108970c7623
