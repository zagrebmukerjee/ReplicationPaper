...
ggplot(data = ntile_summary,
  ...
  theme_minimal() +
  ylab("Manufacturing Losses (04-11)") +
  xlab("Deciles")+
  ggtitle("Manufacturing Job Losses from 2004-2011 by Deciles") +
  geom_col(fill = "#4287f5") +
